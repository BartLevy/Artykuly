...
Europe~\cite{garcia2025,eudir2001110}. Applying uniform
morphological and microbiological criteria to assess honeys from
different production systems is methodologically inadequate and
unfair to producers in developing
countries~\cite{phiri2022,tadele2025}.
...
\subsubsection{Traditional log and basket hives}
...
impossible without destroying the combs; applying the European
morphological criterion to these systems is a direct example
of normative eurocentrism~\cite{tadele2025}.
...
%,----------------------------------------------------------
\subsection{Specific microclimates and weather conditions in the temperate zone (including Europe)}
...
%,----------------------------------------------------------
\subsection{Normative argument: eurocentrism of the morphological standard}
%,----------------------------------------------------------
