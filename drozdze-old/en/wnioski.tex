...
boundary below which honey fermentation is thermodynamically
impossible, regardless of the yeast count expressed in
...
\textbf{(C4) Honey standards are eurocentric and inadequate for global production systems and microclimatic conditions.}
...
%,----------------------------------------------------------
\subsection{Assessment of the Apimondia position}
%,----------------------------------------------------------
...
quality standards. In this respect, the intention and direction of
Apimondia's action deserve full support.
...
%,----------------------------------------------------------
\subsection{Proposed model: synthesis}
%,----------------------------------------------------------

The proposed functional maturity assessment model (FMAM) offers
an operational honey quality assessment tool that:
...
\begin{itemize}
    ...
    \item is \textbf{globally applicable}, since criteria based
...
%,----------------------------------------------------------
\subsection{Limitations and directions for further research}
%,----------------------------------------------------------
