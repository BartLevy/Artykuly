...
temperature~\cite{ruegg1981,gleiter2006}.
...
The practical implication is direct: honey containing even
$10^4$~CFU/g of osmophilic yeasts, but with moisture of $17\%$
($a_w \approx 0{,}57$--$0{,}58$), will not ferment under any
storage conditions at room temperature~\cite{alwaili2012}.
...
the honey is liquid or crystallized. A CFU/g measurement without
specification of the phase state and $a_w$ is therefore
...
$25\,^\circ$C for 5~days~\cite{intechopen_microb2017}. This method,
while widely used and well-validated, has a number of significant
...
\begin{enumerate}
    \item \textbf{Failure to distinguish viable from dead cells:}
          ...
          count~\cite{intechopen_microb2017};
...
Therefore, fermentation cannot serve as evidence of deliberate
product adulteration. Deliberate adulteration consisting of
