...
Europejską odpowiedzią na strukturalną zależność od dostawców spoza Unii Europejskiej jest opracowanie koncepcji \textbf{suwerenności danych cyfrowych}. Składa się ona z trzech wymiarów: rezydencja danych (\textit{data residency}), suwerenność prawna (\textit{data sovereignty}) oraz  suwerenność operacyjna (\textit{operational sovereignty}). Kluczowym problemem jest fakt, że
...
Warto podkreślić, że takie podejście wpisuje się bezpośrednio w oczekiwania polskiego i europejskiego nadzoru finansowego. Komisja Nadzoru Finansowego już w Komunikacie Chmurowym z 2020 roku wymagała od podmiotów nadzorowanych, by informacje prawnie chronione były szyfrowane zawsze \textit{at rest} oraz \textit{in transit} \autocite{knf2020chmura}, a kontrola nad kluczami
kryptograficznymi pozostawała po stronie instytucji finansowej, nie dostawcy chmury.
Obowiązujące od stycznia 2025~r. rozporządzenie DORA idzie o krok dalej, nakładając wymóg kompleksowej polityki szyfrowania obejmującej dane \textit{at rest}, \textit{in transit}, a także \textit{in use}, co jest bezpośrednim odniesieniem do scenariusza, w którym przetwarzanie poufne staje się nie tyle opcją, ile techniczną odpowiedzią na regulacyjne oczekiwania \autocite{dora2022}\autocite{dora_rts2024}.

Z perspektywy jurysdykcyjnej, szczególnie wynikającej z ryzyk CLOUD Act, poufne obliczenia umożliwiają techniczne egzekwowanie reguł dotyczących lokalizacji przetwarzania, operacje mogą być wykonywane wyłącznie w autoryzowanych geograficznie lokalizacjach (\textit{powinowactwo lokalizacji}) i na dedykowanych hostach (\textit{powinowactwo hosta}) \autocite{ijaibdcms2024tee}. Co ważne, choć sama technologia nie uchyla prawnych obowiązków dostawcy wynikających z amerykańskiej ustawy CLOUD Act, to utrudnia realizację ewentualnych nakazów dostępu, a przede wszystkim eliminuje ryzyko cichego dostępu
...
Maximilian Schrems, jest austiackim prawnikiem, działaczem na rzecz ochrony prywatności i założycielem organizacji pozarządowej \textit{noyb} (None of Your Business), zajmującej się egzekwowaniem europejskich przepisów o ochronie danych. W wyniku działania Schrems-a sprawę do Trybunału Sprawiedliwości Unii Europejskiej (TSUE) z wnioskiem o wydanie orzeczenia w trybie prejudycjalnym. 
...
się inicjatywy: \textit{EU Data Act}, \textit{EUCS} oraz projektowany  \textit{Cloud and AI Development Act} adresują kolejno: prawa dostępu do danych i~ich przenoszalność, certyfikację bezpieczeństwa dostawców chmury oraz budowę europejskiej infrastruktury obliczeniowej.
...
Najdalej idącą inicjatywą jest planowany \textit{Cloud and AI Development Act}
(CADA), którego propozycja legislacyjna Komisji Europejskiej planowana jest na I~kwartał 2026~r.\ w~ramach
programu prac Komisji COM(2025) 870~\autocite{ec_workprogramme2026}. Projekt
opiera się na trzech filarach: rozbudowie europejskiej infrastruktury
obliczeniowej (w~tym fabryk AI, \textit{AI Gigafactories}), ustanowieniu
ram prawnych dla bezpiecznego przetwarzania danych w~chmurze oraz
wzmocnieniu europejskiej niezależności infrastrukturalnej~\autocite{eprs_cada2025}.

CADA wyrasta bezpośrednio z~rekomendacji raportu Draghiego z~2024~r.,
który eksplicite wskazał strukturalną zależność UE od nieeuropejskich
dostawców chmury jako ryzyko strategiczne dla konkurencyjności europejskiej
gospodarki~\autocite{draghi2024}. Projekt zakłada możliwość nałożenia kar
finansowych za niezgodność, a~jego podstawą prawną ma być art.~114 Traktatu
o~Funkcjonowaniu Unii Europejskiej~\autocite{ec_workprogramme2026}.
...
dostawców, a~CADA ma budować alternatywną, europejską infrastrukturę
\textit{ex ante}. Z~perspektywy metodologii ORION istotne jest jednak,
że żadna z~tych regulacji nie eliminuje jeszcze w~całości konfliktu
jurysdykcyjnego wynikającego z~CLOUD Act: Data Act nie uchyla prawnych
obowiązków dostawcy wynikających z~prawa USA, a~EUCS pozostaje nieukończony
na poziomie wymaganym dla usług krytycznych.
...
\textbf{czynnika ryzyka, którego nie można się pozbyć} w~drodze samej konfiguracji
...
\subsection{Trzy warstwy ryzyka}

\paragraph{Warstwa 1, Chmura a CLOUD Act.}
...
\paragraph{Warstwa 2, Windows Server a telemetria.}
Windows Server uruchomiony jako VM na chmurze generuje telemetrię przesyłaną
do serwerów Microsoft. Oznacza to \textbf{dwa niezależne podmioty
...
\paragraph{Warstwa 3, Dostęp Google do danych bazy danych.}
...
\begin{enumerate}
  \item \textbf{CMEK z zewnętrznym HSM} (\textit{Customer-Managed
  ...
  \item \textbf{Audyt umów z dostawcami chmurowymi} pod kątem klauzul
