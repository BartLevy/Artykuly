...
w~wiarygodny sposób ze statusem dopuszczenia próbki do obrotu.
...
błędnie wykluczyłoby z~obrotu \textbf{36.0\%} próbek miodów legalnie
dopuszczonych do obrotu, a~jednocześnie przepuszczało
\textbf{58.0\%} próbek niedopuszczonych.
Skuteczność tak skonstruowanego kryterium ($\mathrm{AUC} \approx 0.53$)
...
Włączenie takiego kryterium do procedur dopuszczenia do obrotu prowadziłoby
